...
public class AdvancedBinaryConverter implements ActionListener {
    ...
    public void actionPerformed(ActionEvent arg0) {
    	...
    	if(convertButton == arg0.getSource()) {
