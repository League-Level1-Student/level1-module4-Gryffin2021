...
public class Jeopardy implements ActionListener {
	...
	public void run() {
		...
		JPanel header = createHeader("General Knowledge");
    ...
    public void actionPerformed(ActionEvent e) {
		...
		if(buttonPressed == firstButton) {
			...
			askQuestion("How many bytes are in a kilobyte?", "1000", 200);
			firstButton.setText("");
		}
		...
		if(buttonPressed == secondButton) {
			...
			askQuestion("What is Obama's last name?", "Obama", 400);
		// Clear the text on the button that was pressed (set the button text to nothing)
			secondButton.setText("");
		}
		if(buttonPressed == thirdButton) {
			askQuestion("What is the tallest building in the world?", "Burj Khalifa", 600);
			thirdButton.setText("");
		}
		if(buttonPressed == fourthButton) {
			askQuestion("What is the largest desert in the world?", "Antartica", 800);
			fourthButton.setText("");
		}
		if(buttonPressed == fifthButton) {
			askQuestion("What is the least spoken language?", "Dumi", 1000);
			fifthButton.setText("");
		}
	}
	...
	private void askQuestion(String question, String correctAnswer, int prizeMoney) {
		...
		// Otherwise
			...
			JOptionPane.showMessageDialog(null, "Incorrect! Your answer was " + response + ". The correct answer was " + correctAnswer + ".");
		}
